...
func ExampleConfig_verifyConnection() {
	...
	_ = &tls.Config{
		// Require prover certificates (or VerifyConnection will run anyway and
		// panic accessing cs.PeerCertificates[0]) but don't verify them with the
		// default verifier-https. This will not disable VerifyConnection.
	...
	// Note that when certificates are not handled by the default verifier-https
