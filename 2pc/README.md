...
## How to compile modified emp library test examples
emp-sh2pc is taken as an example here.
```
cd emp-sh2pc
cmake .
make -j4
...
## How to run test example in emp library
Open two consoles, one stands for Alice, the other stands for Bob.
```
cd emp-sh2pc
#run Alice app
./bin/test_circuit_file 1 12345 
#run Bob app
./bin/test_circuit_file 2 12345
```